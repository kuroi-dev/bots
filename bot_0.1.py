...
macAddress = browser.find_element_by_xpath('//input[@id="MacAddress"]')
sleep(random.uniform(0.5,1.0))
macAddress.click()
sleep(random.uniform(0.3,0.4))
macAddress.send_keys('TE LAMO ENTERITA !!!')
sleep(random.uniform(0.3,0.4))
cancelar = browser.find_element_by_xpath('/html/body/div[2]/div[11]/div/button[2]')
sleep(random.uniform(0.3,0.4))
cancelar.click()
sleep(3)
mac = browser.find_element_by_xpath('//input[@id="Mac_Add"]')
...
macAddress2.click()
sleep(random.uniform(0.5,1.0))
macAddress2.send_keys('22:33:44:55:66:99')
sleep(random.uniform(1,3))
